...
//     _fetchUnavailableDates();  // Fetch the unavailable dates
//   }
//
//   // Fetch the unavailable dates from Firestore
...
//   }
//
//   // Function to submit the user request with selected dates
...
//   }
//
//   // Toggle the selected dates on the calendar
...
//                   style: ButtonStyle(
//                     backgroundColor:WidgetStatePropertyAll(selectedDates.isEmpty ? Colors.grey : Colors.blue.shade200)
//                   ),
...
//                     openChckout();
//                   },
//                   child: Text('Continue',style: TextStyle(color: selectedDates.isEmpty
//                       ? Colors.white
//                       : Colors.black),),
//                 ),
//               ),
...
//     );
//   }
//   void showAlertDialog(BuildContext context, String title, String message,IconData icon,iconClr){
//
