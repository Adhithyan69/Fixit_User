  ...
  void filterCategory(String query) {
    setState(() {
      filteredCategories = availableCategories.where((doc) {
        ...
        String workerField = doc.data()['workerField']?.toLowerCase() ?? '';
        String workerPh = doc.data()['workerPh']?.toLowerCase() ?? '';
        String workerEmail = doc.data()['workerEmail']?.toLowerCase() ?? '';
        return workerName.contains(query.toLowerCase()) ||
            workerField.contains(query.toLowerCase()) ||
            workerPh.contains(query.toLowerCase()) ||
            workerEmail.contains(query.toLowerCase());
      }).toList();
    });
    print(query);
